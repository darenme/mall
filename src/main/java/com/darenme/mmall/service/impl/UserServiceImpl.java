...
import com.darenme.mmall.common.TokenCache;
import com.darenme.mmall.pojo.User;
import com.darenme.mmall.common.Const;
import com.darenme.mmall.dao.UserMapper;
import com.darenme.mmall.service.IUserService;
import com.darenme.mmall.util.MD5Util;
...
public class UserServiceImpl implements IUserService {
     ...
     * @param str  待检查的值
     * @param type 待检查的类型
     * @return 返回ErrorMessage表示表示该值已存在，返回SuccessMessage表示该值尚未存在
     */
